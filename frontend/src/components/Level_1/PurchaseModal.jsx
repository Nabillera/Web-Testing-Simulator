...
export function PurchaseModal({ onHandleModal, totalPrice }) {
  return (
    <div className="absolute top-[30%] left-[30%] p-[20px] flex flex-col gap-y-[20px] items-center bg-[#D9D9D9]/95 border-2 rounded-[25px] w-[700px] shadow-[10px_10px_10px_rgba(0,0,0,0.5)]">
